...
function sGj() { p.writeln(o.slice(30,60).concat(o.slice(0,30))) };
function sDj() { p.writeln(o.slice(5, 60).concat(o.slice(0, 5))) };
function sAj() { p.writeln(o.slice(40,60).concat(o.slice(0,40))) };
function sEj() { p.writeln(o.slice(15,60).concat(o.slice(0,15))) };
function sBj() { p.writeln(o.slice(50,60).concat(o.slice(0,50))) };
function sFn() { p.writeln(o.slice(25,60).concat(o.slice(0,25))) };
function sCn() { p.writeln(o.slice(0, 60).concat(o.slice(0, 0))) };
function sGn() { p.writeln(o.slice(35,60).concat(o.slice(0,35))) };
function sDn() { p.writeln(o.slice(10,60).concat(o.slice(0,10))) };
function sAn() { p.writeln(o.slice(45,60).concat(o.slice(0,45))) };
function sEn() { p.writeln(o.slice(20,60).concat(o.slice(0,20))) };
function sBn() { p.writeln(o.slice(55,60).concat(o.slice(0,55))) };
function sfk() { p.writeln(o.slice(30,60).concat(o.slice(0,30))) };
function sCk() { p.writeln(o.slice(5, 60).concat(o.slice(0, 5))) };
function sGk() { p.writeln(o.slice(40,60).concat(o.slice(0,40))) };
function sDk() { p.writeln(o.slice(15,60).concat(o.slice(0,15))) };
function sAk() { p.writeln(o.slice(50,60).concat(o.slice(0,50))) };
